...
) => (typeof organization === "object" ? organization.id : organization);
...
function ProjectFormModal({
  ...
  const [form, setForm] = useState<ProjectPayload>(() =>
    project
      ? {
          ...
          organization_id: getOrganizationId(project.organization),
  ...
  const setField = <K extends keyof ProjectPayload>(
    field: K,
        ...
        >
          ...
          {!project && (
            <label className="form-control">
              ...
              <select
                ...
                onChange={(event) =>
                  setField("organization_id", event.target.value)
                }
                className="select select-bordered w-full rounded-xl bg-base-200/60"
              ...
              {noOrganizations && (
                <span className="mt-2 text-xs text-warning">
                  You need to belong to an organization before creating a
                  project.
                </span>
              )}
            </label>
          ...
          <label className="form-control">
            ...
            <textarea
              ...
              className="textarea textarea-bordered min-h-28 resize-y rounded-xl bg-base-200/60"
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            <label className="form-control">
              ...
              <input
                ...
                className="input input-bordered rounded-xl bg-base-200/60"
              />
            </label>
            <label className="form-control">
              <span className="mb-2 text-sm font-medium text-base-content">
            ...
            <label className="form-control">
              ...
              <div className="join">
                <input
                  ...
                  className="input input-bordered join-item min-w-0 flex-1 rounded-l-xl bg-base-200/60"
                  placeholder="Optional"
                />
                <input
                  value={form.budget_currency || "IRR"}
                  onChange={(event) =>
                    setField(
                      "budget_currency",
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-base-content/10 pt-5 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              disabled={
                isPending ||
                !form.name.trim() ||
                (!project && (!form.organization_id || noOrganizations))
              }
...
export default function ProjectsPage() {
  ...
  const lifecycleMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "Could not update project status.")),
  });
    ...
    <div className="min-h-[calc(100vh-121px)] space-y-6 pb-10">
      ...
      {projectsQuery.isLoading ? (
        ...
        <div className="madaar-surface rounded-[28px] border border-dashed border-base-content/15 bg-base-100 px-6 py-16 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm text-base-content/55">
            Create the first project and it will immediately become available in
            the Tasks workspace.
          </p>
          <button
            type="button"
          ...
          <AnimatePresence mode="popLayout">
            {projects.map((project) => (
              <motion.article
                ...
                className="madaar-surface group rounded-2xl border border-base-content/10 bg-base-100 p-5 transition hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-xl hover:shadow-primary/5"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  >
                    ...
                    <span className="min-w-0">
                      <span className="block truncate text-lg font-semibold text-base-content">
                        {project.name}
                      </span>
      ...
      {modalProject !== undefined && (
        <ProjectFormModal
          ...
          onSubmit={(payload) =>
            saveMutation.mutate({ project: modalProject, payload })
          }
